...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT(
      ...
      KC_TRNS, KC_TRNS, KC_TRNS,    KC_UP, KC_TRNS, KC_TRNS, 			KC_LGUI(KC_C), KC_LGUI(KC_Z), KC_TRNS, KC_TRNS, KC_LGUI(KC_V),  KC_TRNS,    KC_TRNS,
      KC_TRNS,   KC_TRNS, KC_TRNS, KC_TRNS, KC_LGUI(KC_X),   KC_TRNS, KC_TRNS, 	KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_TRNS, KC_TRNS,  KC_TRNS,    
